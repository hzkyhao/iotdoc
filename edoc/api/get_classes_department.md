...
let res = await api.get_classes_department(requestParams)
if (res) {
// Success
} else {
// Error
...
*other usage*
```javascript
api.get_classes_department_TYPE()
api.get_classes_department_RAW_URL()
api.get_classes_departmentURL(requestParams)
```
