...
let res = await api.get_classes_notification(requestParams)
if (res) {
// Success
} else {
// Error
...
*other usage*
```javascript
api.get_classes_notification_TYPE()
api.get_classes_notification_RAW_URL()
api.get_classes_notificationURL(requestParams)
```
