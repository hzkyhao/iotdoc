...
let res = await api.get_classes_product(requestParams)
if (res) {
// Success
} else {
// Error
...
*other usage*
```javascript
api.get_classes_product_TYPE()
api.get_classes_product_RAW_URL()
api.get_classes_productURL(requestParams)
```
