...
let res = await api.get_classes_channel(requestParams)
if (res) {
// Success
} else {
// Error
...
*other usage*
```javascript
api.get_classes_channel_TYPE()
api.get_classes_channel_RAW_URL()
api.get_classes_channelURL(requestParams)
```
