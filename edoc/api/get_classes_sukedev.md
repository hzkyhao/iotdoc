...
let res = await api.get_classes_sukedev(requestParams)
if (res) {
// Success
} else {
// Error
...
*other usage*
```javascript
api.get_classes_sukedev_TYPE()
api.get_classes_sukedev_RAW_URL()
api.get_classes_sukedevURL(requestParams)
```
