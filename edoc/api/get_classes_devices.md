...
let res = await api.get_classes_devices(requestParams)
if (res) {
// Success
} else {
// Error
...
*other usage*
```javascript
api.get_classes_devices_TYPE()
api.get_classes_devices_RAW_URL()
api.get_classes_devicesURL(requestParams)
```
