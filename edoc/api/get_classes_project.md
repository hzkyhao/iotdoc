...
let res = await api.get_classes_project(requestParams)
if (res) {
// Success
} else {
// Error
...
*other usage*
```javascript
api.get_classes_project_TYPE()
api.get_classes_project_RAW_URL()
api.get_classes_projectURL(requestParams)
```
